...
import { deleteRecipe, removeFavoriteRecipe } from '../../redux/profile/profileOperations';
import { IconButton } from '../common/ui';

import css from './ListItem.module.css';

export const ListItem = ({ image, title, instructions, id, isFavorite, isCurrentUser }) => {
    ...
    const handleRemove = async id => {
        ...
        try {
            ...
            iziToast.error({
                title: 'Error',
                message: isFavorite ? 'Failed to remove from favorites' : 'Failed to delete recipe',
                position: 'topRight',
            });
