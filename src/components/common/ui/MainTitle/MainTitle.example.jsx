    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '60px' }}>
            ...
            <div
                ...
                <h3 style={{ marginBottom: '20px', color: '#333' }}>Адаптивные размеры:</h3>
                <ul
                    style={{
                        listStyle: 'none',
                        padding: 0,
                    ...
                    <li>📱 Мобильные устройства (&lt; 480px): 40px</li>
                    <li>📱 Мобильные устройства (480px+): 48px</li>
                    <li>📱 Планшеты (768px+): 70px</li>
                    <li>💻 Десктопы (1024px+): 90px</li>
                    <li>🖥️ Большие экраны (1440px+): 100px</li>
                </ul>
            </div>
            ...
            <div
                ...
                <h4 style={{ marginBottom: '20px', color: '#333' }}>Семантические теги:</h4>
            ...
            <div
                ...
                <ul style={{ margin: '8px 0', paddingLeft: '20px' }}>
                    ...
                    <li>✅ Адаптивные размеры</li>
                    <li>✅ Оптимизация рендеринга</li>
                    <li>✅ Семантические HTML теги</li>
                </ul>
            </div>
        </div>
    );
